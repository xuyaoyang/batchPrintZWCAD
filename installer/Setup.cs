...
internal static class Setup
{
    ...
    internal static string Install(List<CadTarget> targets)
    {
        ...
        string folder = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "LA BatchPlot", "20260922-R7-" + Guid.NewGuid().ToString("N").Substring(0, 8));
        Extract(folder);
