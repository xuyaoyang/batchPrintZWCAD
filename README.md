...
面向中望 CAD 和 AutoCAD 的批量打印插件。本仓库维护基于 [Edwardhehe/batchPrintZWCAD](https://github.com/Edwardhehe/batchPrintZWCAD) v1.15.7.5 的扩展版本，保留上游历史、作者信息和 MIT 许可。当前扩展版本：**2026-09-22 修订6**（程序集基础版本仍为 1.15.7.5）。
